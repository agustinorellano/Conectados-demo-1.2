...
const recommendations = [
  ...
  },
  {
    company_id: 'top-white',
    area: 'general',
    title: 'Definir narrativa de Conectados como motor de alianzas',
...
export const recommendedCompanies = alliances
  ...
  .map((alliance) => {
    ...
    return {
      ...
      distance: 2 + ((company.id.charCodeAt(0) * 3 + company.id.charCodeAt(2)) % 28),
